...
<template>
  <body class="grid gap-44">
    <section class="flex items-end h-[40vh] px-32 justify-center bg-[#04151E]">
      <h1 class="text-white mb-8">While In Battle</h1>
    </section>
    ...
    <section class="grid grid-cols-2 px-56 gap-x-20 gap-y-16">
      ...
      <div>
        <img src="/media/whilePlakat.png" alt="" />
      </div>
    </section>
    ...
    <section class="mx-56">
      ...
      <img src="/media/FarveMoodboard.jpg" alt="" />
    </section>
    ...
    <section class="mx-56">
      ...
      <img src="/media/styletyle.png" alt="" />
    </section>
    ...
    <section class="mx-56">
      <article class="mx-32">
        ...
        <p>
          ...
          at tage et kig på konkurrenterne, ses det at deres visuelle identitet
          klart afspejler dansk møbeldesign, med enkelthed og naturen i fokus.
          Ud fra en analyse af trends og tendenser kan man dog se at farver, der
          står i kontrast til de analoge naturfarver, er efterspurgte i den
          danske boligindretning. Så ved at sælge dansk møbeldesign med fokus på
          farver, skiller Valør sig ud fra konkurrenterne, og giver samtidig
          deres kunder en mulighed for at bringe farver ind i boligindretningen.
          ...
          med. Valørs målgruppe er altså familier og personer, der giver plads
          til farver og leg i boligindretningen, men som også ved at de ikke kan
      ...
      <video autoplay loop muted class="z-0 h-fit w-fit object-cover">
        <source
          class="h-full"
          src="/media/KampagnesiteMedInteraktivtElementJosefineAlberte.mp4"
          type="video/mp4"
        />
      ...
      <div class="grid grid-cols-4">
        <img src="/media/lightRed.png" alt="" />
        <img src="/media/lightOrange.png" alt="" />
        <img src="/media/lightGreen.png" alt="" />
        <img src="/media/lightBlue.png" alt="" />
      </div>
    </section>
    ...
    <section class="mx-56">
      ...
      <div class="grid grid-cols-2">
        <img src="/media/MockupFysiskInstallationJosefineAlberte.png" alt="" />
        <video autoplay loop muted class="z-0 h-full object-cover">
          <source
            class="h-full"
            src="/media/FysiskInstallationVideoJosefineAlberte.mp4"
            type="video/mp4"
          />
      ...
      <div class="mt-20 grid justify-center">
        <img class="w-96" src="/media/whilePlakat.png" alt="" />
      </div>
    </section>
